 ...
 */
package br.com.kafkafull.model;
...
public class PessoaDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3031702501995822213L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PessoaDTO\",\"namespace\":\"br.com.kafkafull.model\",\"fields\":[{\"name\":\"nome\",\"type\":\"string\"},{\"name\":\"sobrenome\",\"type\":\"string\"}]}");
   ...
   */
  public static br.com.kafkafull.model.PessoaDTO.Builder newBuilder() {
    return new br.com.kafkafull.model.PessoaDTO.Builder();
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static br.com.kafkafull.model.PessoaDTO.Builder newBuilder(br.com.kafkafull.model.PessoaDTO.Builder other) {
    return new br.com.kafkafull.model.PessoaDTO.Builder(other);
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static br.com.kafkafull.model.PessoaDTO.Builder newBuilder(br.com.kafkafull.model.PessoaDTO other) {
    return new br.com.kafkafull.model.PessoaDTO.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PessoaDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.kafkafull.model.PessoaDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.kafkafull.model.PessoaDTO other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.nome)) {
        this.nome = data().deepCopy(fields()[0].schema(), other.nome);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.kafkafull.model.PessoaDTO.Builder setNome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.kafkafull.model.PessoaDTO.Builder clearNome() {
      nome = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.kafkafull.model.PessoaDTO.Builder setSobrenome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.kafkafull.model.PessoaDTO.Builder clearSobrenome() {
      sobrenome = null;
